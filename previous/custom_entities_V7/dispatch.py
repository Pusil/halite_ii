...
class Dispatch:
    ...
    def create_ship(self, ship):
        self.ships.append(custom_entities_V7.Ships(ship, game_map=self.game_map))

    def create_planets(self):
        for planet in self.game_map.all_planets():
            self.planets.append(custom_entities_V7.Planets(planet, game_map=self.game_map))

    def create_squadron(self, ship):
        self.squadrons.append(custom_entities_V7.Squadron(ship, self, game_map=self.game_map))
